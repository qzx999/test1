<template>
    <div>
        ...
        <Form :model="queryForm" ref="myForm" style="margin: 10px">
            <FormItem>
                ...
                <Row>
                    ...
                    <Col span="5">
                        <Row>
                            <Col span="8" align="right"><span>任务接收人：</span></Col>
                            <Col span="10">
                    ...
                    <Col span="4">
                        <Row>
                            <Col span="8" align="right"><span>波次：</span></Col>
                            <Col span="10">
        ...
        <Row>
            <Col span="20">
                <Button @click="">批量设置任务接收人</Button>
                <Button @click="">批量确认</Button>
                <Button @click="">波次生成</Button>
...
<script>
    import * as taskConfirmApi from '@/api/outGoods/taskConfirmApi.js';
    export default {
        name: "taskConfirm",
        data() {
            return {
        ...
        methods:{
            ...
            initMyColumns(){
                return[
                    ...
                    {key:'updateName',title:'更新人名称',align:'center',width:100},
                    {key:'updateDate',title:'更新日期',align:'center',width:100},
            ...
            //获取列表数据
            getList(){
                taskConfirmApi.getList(this.requestParameters).then(res =>{
            ...
            //条件查询
            query(){
                taskConfirmApi.queryList(this.queryForm).then(res =>{
                    if(res.data.code == 200) {
                        this.myData =res.data.data.rows;
                        this.requestParameters.total = res.data.data.total;
                        this.loading = false;
            ...
            out(data){
                ...
                this.$Modal.confirm({
                    ...
                    content:`确定要删除吗？`,
                    onOk:() =>{
                        taskConfirmApi.deleteById(id).then(res =>{
                            if(res.data.code == 200) {
