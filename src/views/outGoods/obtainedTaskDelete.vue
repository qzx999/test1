...
<script>
    import * as obtainedTaskDeleteApi from '@/api/outGoods/obtainedTaskDeleteApi.js';
    export default {
        ...
        methods:{
            ...
            //获取列表数据
            getList(){
                obtainedTaskDeleteApi.getList(this.requestParameters).then(res =>{
            ...
            //条件查询
            query(){
                obtainedTaskDeleteApi.queryList(this.queryForm).then(res =>{
                    if(res.data.code == 200) {
                        this.myData =res.data.data.rows;
                        this.requestParameters.total = res.data.data.total;
                        this.loading = false;
            ...
            out(data){
                ...
                this.$Modal.confirm({
                    ...
                    content:`确定要删除吗？`,
                    onOk:() =>{
                        obtainedTaskDeleteApi.deleteById(id).then(res =>{
                            if(res.data.code == 200) {
